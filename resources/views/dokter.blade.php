...
<body>
    <nav class="tekstentang navbar sticky-top navbar-expand-lg bg-light">
        <div class="container-fluid">
            <img class="img-fluid" style="width: 55px;" src="/images/logo.png" alt="image">
    ...
    <div class="bg-color" style="background-color: rgb(115, 169, 220)">
        <div class="dokter">
            <div class="container-fluid">
                    ...
                    <div class="card-deck mx-auto mt-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><center>Umum</center></p>
                            </div>
                            <div class="card-footer">
                ...
                <div class="row">
                    <div class="card-deck mx-auto mt-5">
                        ...
                        <div class="card">
                            <img src="/images/dokter10.webp" class="card-img-top" alt="...">
                            <div class="card-body">
                        ...
                        <div class="card">
                            <img src="/images/dokter9.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
